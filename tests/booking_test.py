...
class TestBooking(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.booking2 = Booking(self.member2.member_id, self.session1.session_id, True)
        self.booking3 = Booking(self.member2.member_id, self.session3.session_id, True)

    # Test removed as booking_id is going to be generated by the database.
    # def test_booking_has__booking_id(self):
        # self.assertEqual(1, self.booking1.booking_id)

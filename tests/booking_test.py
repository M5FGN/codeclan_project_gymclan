...
class TestBooking(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.booking1 = Booking(self.member1.member_id, self.gymsession3.gymsession_id)
        self.booking2 = Booking(self.member2.member_id, self.gymsession1.gymsession_id, True, 2)
        self.booking3 = Booking(self.member2.member_id, self.gymsession3.gymsession_id, True, 3)
